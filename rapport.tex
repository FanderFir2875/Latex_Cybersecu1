...
\fancyhf{}
\lhead{Serpent}
\rhead{UNC - Cybersécurité 1 - 2025}
\cfoot{\thepage}
...
\begin{titlepage}
    ...
    \centering
    {\Large Rapport - Cybersécurité 1\par}
...
\hline
Tour $i \in [0,30]$ & $X_{i+1} = LT(S_{i \bmod 8}(X_i \oplus K_i))$ \\
\hline
Tour final & $C = S_{31 \bmod 8}(X_{31} \oplus K_{31}) \oplus K_{32}$ \\
\hline
\end{tabular}
\end{center}
